...
def generate_article(row: dict):
    ...
    system_prompt = (
        "You are a professional travel blog writer. Write high-quality blog posts that feel natural, useful, "
        "specific, and human. Avoid generic filler. Use markdown. Do not use fake facts or fake prices. "
        "Do not mention that the article was generated by AI. Do not begin with phrases like "
        "'Tentu', 'Berikut', 'Ini adalah draf', or any meta introduction. Start directly with the article."
    )
...
- Gunakan markdown.
- Langsung mulai artikel. Jangan beri pengantar meta seperti "Tentu" atau "Berikut artikelnya".
- Struktur minimal:
  1. pembuka
